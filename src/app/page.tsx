...
const page = () => {
  ...
  //Calculation starts
  // Step 1: Calculate individual item amount (quantity * rate + item tax)
  ...
  // Update item and recalculate everything
  const updateItem = (index: number, field: keyof InvoiceItem, value: any) => {
    ...
    // Calculate amount for updated item
    ...
    const mainTax = calculateMainTax(subtotal, formData.taxPercentage);
    const discount = calculateDiscount(subtotal, formData.discountPercentage);
    const total = subtotal + mainTax - discount + formData.shippingAmount;
  ...
  // Effect to recalculate totals when relevant values change
  useEffect(() => {
